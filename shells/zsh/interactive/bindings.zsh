...
# bindkey '^P'    up-line-or-beginning-search-local   # ctrl+p         prev command in local history
# bindkey '^N'    down-line-or-beginning-search-local # ctrl+n       next command in local history
