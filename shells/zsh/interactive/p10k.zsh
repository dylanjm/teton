# Generated by Powerlevel10k configuration wizard on 2019-08-15 at 13:03 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS}_FOREGROUND=202
  ...
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %9F'${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}'${VCS_STATUS_NUM_UNTRACKED}}'
  ...
  #################################[ personal_icon: personal identifier ]##################################
  function prompt_lambda () {
      p10k segment -f 9 -i $'\u03BB'
  }
}
