...
(custom-set-variables
 ...
 '(TeX-view-program-list
   '(("PDF Viewer" "/Applications/Skim.app/Contents/SharedSupport/displayline -b -g %n %o %b")) t)
 '(TeX-view-program-selection '((output-pdf "PDF Viewer")) t)
