...
/last updated/: 2019-11-14 13:53:40
...
#+begin_src emacs-lisp
  ...
  (use-package dired-hacks-utils
    :straight (:host github :repo "dired-hacks"))
...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil :inherit 'default
                      :family "Source Sans Pro" :weight 'light)

  ;(set-face-attribute 'fixed-pitch nil :inherit 'default
   ;                   :family "Iosevka Nerd Font" :weight 'ultralight :slant 'normal)
#+end_src
