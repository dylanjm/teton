...
/last updated/: 2019-11-19 10:56:08
...
#+begin_src emacs-lisp
  ...
  (use-package direnv
    ...
    (defun djm/direnv-make-process-env-buffer-local-a (items)
      (when items
        (mapc 'kill-local-variable '(process-environment exec-path))
        (mapc 'make-local-variable '(process-environment exec-path))
        items))

    (advice-add #'direnv--export :filter-return #'djm/direnv-make-process-env-buffer-local-a))
  ...
  (use-package compile
    :straight nil
    :hook (compilation-mode . (lambda () (direnv-update-environment)))
    :preface
...
#+begin_src emacs-lisp
  ...
  (use-package all-the-icons
    :demand t
    :straight (:files ("data" "fonts" "*.el") :host github :repo "domtronn/all-the-icons.el")
...
#+begin_src emacs-lisp
  ...
  (use-package highlight-indent-guides
    :blackout t
    :straight (:host github :repo "https://github.com/DarthFennec/highlight-indent-guides")
...
#+begin_src emacs-lisp
  (use-package key-chord
    :blackout t
    :straight t
    :hook (after-init . (lambda () (key-chord-mode +1)))
    :custom
...
#+begin_src emacs-lisp
  (use-package posframe
    ...
    (defun hemacs-posframe-arghandler (posframe-buffer arg-name value)
      (let ((info '(:internal-border-width 10 :min-width 70)))
...
#+begin_src emacs-lisp
  ...
  (use-package company-box
    ...
    (company-box-icons-all-the-icons t))
#+end_src
