...
/last updated/: 2019-12-13 16:10:37
...
*** [[https://github.com/Foltik/use-package-company][Use-Package-Company]]
...
#+begin_src emacs-lisp
  (use-package company
    ...
    :config
    (general-setq company-async-timeout 15
    ...
    (general-setq company-auto-complete (lambda ()
                                          (and (company-tooltip-visible-p)
                                               (copmany-explicit-action-p))))

    (general-setq company-continue-commands '(not save-buffer
                                                  save-some-buffers
