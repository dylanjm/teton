...
declare -A TRUELINE_COLORS_DEFAULT=(
	[black]='53;53;53' #353535
	[red]='215;57;37' #d73925
	[green]='168;165;33' #a8a521
	[yellow]='223;168;42' #dfa82a
	[blue]='84;150;153' #549699
	[magenta]='191;120;151' #549699
	[cyan]='121;170;125' #79aa7d
...
if [[ "${#TRUELINE_SEGMENTS[@]}" -eq 0 ]]; then
	declare -a TRUELINE_SEGMENTS=(
		...
		'venv,black,magenta,bold'
		'git,black,green,bold'
		'working_dir,black,cyan,bold'
