...
#+html: <style>.inline-block { display: inline-block;}</style> <div id="banner"> <div class="inline-block"> <img alt="macOS Support" src="https://img.shields.io/badge/platform-macOS-blue"> </div> <div class="inline-block"> <img alt="Main Editor: Emacs" src="https://img.shields.io/badge/editor-Emacs27%2B-blueviolet"> </div> <div class="inline-block"> <img alt="Main Shell: ZSH" src="https://img.shields.io/badge/shell-ZSH-orange"> </div> <div class="inline-block"> <img alt="GitHub last commit" src="https://img.shields.io/github/last-commit/dylanjm/dotz"> </div> </div>
