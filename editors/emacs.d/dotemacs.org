...
/last updated/: 2019-11-14 16:17:58
...
#+begin_src emacs-lisp
  ...
  (dolist (script '(symbol greek mathematical))
    (set-fontset-font t script (font-spec :family "Arial Unicode MS") nil 'prepend)
...
#+begin_src emacs-lisp
  ...
  (set-face-attribute 'variable-pitch nil :inherit 'default :family "Source Sans Pro" :weight 'light)

  (set-face-attribute 'fixed-pitch nil :inherit 'default :font "Iosevka Nerd Font Mono")
#+end_src
...
**** Testing Stuff
#+name: init-testing-block
#+begin_src emacs-lisp
  (use-package sublimity
    :straight (:host github :repo "zk-phi/sublimity"))
#+end_src
