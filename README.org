...
[[https://unsplash.com/@grakozy?utm_medium=referral&utm_campaign=photographer-credit&utm_content=creditBadge][https://img.shields.io/badge/unsplash-Greg%20Rakozy-black.svg]]

[[file:editors/emacs.d/assets/teton.jpg]]
...
$ git clone https://github.com/dylanjm/teton.git ~/teton
$ cd ~/teton
$ ./install
#+end_src
...
* Features
** Zsh
- Extremly fast and configurable package manager - [[https://github.com/zdharma/zinit][Zinit]].
** Emacs
- Light-weight completion framework
- Strong language and editing support
- Simple and modular.
** Karabiner
"/A powerful and stable keyboard customizer for macOS./"

Custom keyboard configuration made super easy using [[https://github.com/yqrashawn/GokuRakuJoudo][Goku]]. Emacs is configured with a hyper-key using the left-control modifier.
