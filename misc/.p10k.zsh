# Generated by Powerlevel10k configuration wizard on 2019-08-28 at 17:15 MDT.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 57245.
...
() {
  ...
  vcs+=':-${VCS_STATUS_LOCAL_BRANCH[1,12]//\%/%%}%28F…%10F${VCS_STATUS_LOCAL_BRANCH[-12,-1]//\%/%%}}}'
  # '@72f5c8a' if not on a branch.
  vcs+=':-%f@%10F${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUpS_LOCAL_BRANCH}:+%f:%12F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  ...
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %1F'${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}'${VCS_STATUS_NUM_UNTRACKED}}'
